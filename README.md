...
| `/wow-addon:bump-version [X.Y.Z]` | Bump the addon's version everywhere it appears (TOC, code, README badges, Version History table, `CLAUDE*.md`, CHANGELOG). Proposes a bump if no version is given. |
