...
- Verify `docs/` against the canonical set — `ARCHITECTURE.md`, `testing.md`, `smoke-tests.md`, plus the five required topic-detail docs `test-cases.md`, `performance.md`, `perf-runs/README.md`, `automated-tests/README.md` and `automated-tests/RESULTS.md`, and any further topic-detail docs. A surviving `docs/complexity.md` is a **pre-adoption finding to report**, never a missing member to create.
